...
var getParentPage = function getParentPage(num) {
...
/**
   ...
   * 安装方法： npm install extend
    */
var extend = function extend() {//from jquery2
  //辅助函数
  var class2type = {};
  ...
  var dataType = function dataType(obj) {
...
// 授权
var authSetting = function authSetting() {
  uni.getSetting({
    success: function success(res) {
      if (res.authSetting['scope.userInfo']) {
        wx.getUserInfo({
          success: function success(res) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                      // 如果已经授权,在这里可获取相关数据
                      console.log(res);return _context.abrupt("return",
...
var _default = {
  ...
  guid: guid,
  dateTime: dateTime,
  authSetting: authSetting };exports.default = _default;
...
var base64 = __webpack_require__(/*! base64-js */ 135)
var ieee754 = __webpack_require__(/*! ieee754 */ 136)
var isArray = __webpack_require__(/*! isarray */ 137)
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.postSetChagesub = exports.postIsRead = exports.changemobile = exports.getShopAuthentication = exports.getErCode = exports.setShopReply = exports.getFootConfig = exports.getFootInfo = exports.getShopReplyContent = exports.delimages = exports.updateShopInfo = exports.ShopReply = exports.postShopCommentsList = exports.postShopCore = exports.postShopFirst = exports.postSaveShopUser = exports.postMobilelogin = exports.postSendCode = exports.wxLogin = exports.uploadImage = exports.domain = void 0;var common = _interopRequireWildcard(__webpack_require__(/*! ./common.js */ 18));
...
var http = domain + '/api/';
//POST方法
var post = function post(method, data, callback) {
  uni.showLoading({
    title: '加载中' });
...
var get = function get(url, data, callback) {
  ...
  var param = common.builderUrlParams(http + url, data);
...
// code
exports.uploadImage = uploadImage;var wxLogin = function wxLogin(data, callback) {return post('wechat_shop/login', data, callback);};
// 发送验证码
exports.wxLogin = wxLogin;var postSendCode = function postSendCode(data, callback) {return post("sms/send", data, callback);};
// export const postSendCode = (data, callback) => post("user/sendCode", data, callback)
// 手机验证码登录
exports.postSendCode = postSendCode;var postMobilelogin = function postMobilelogin(data, callback) {return post("user/mobilelogin", data, callback);};
// 商家实名认证
exports.postMobilelogin = postMobilelogin;var postSaveShopUser = function postSaveShopUser(data, callback) {return post("Shop_Authentication/saveShopUser", data, callback);};
// 商家是否为首次登陆
exports.postSaveShopUser = postSaveShopUser;var postShopFirst = function postShopFirst(data, callback) {return post("Shop_authentication/shopFirst", data, callback);};
// 商家中心首页
exports.postShopFirst = postShopFirst;var postShopCore = function postShopCore(data, callback) {return post("Shop_authentication/shopCore", data, callback);};
// 首页评论List
exports.postShopCore = postShopCore;var postShopCommentsList = function postShopCommentsList(data, callback) {return post('Shop_authentication/shopCommentsList', data, callback);};
// 个人中心消息
exports.postShopCommentsList = postShopCommentsList;var ShopReply = function ShopReply(data, callback) {return post('shops/ShopReply', data, callback);};
// 商家资料提交
exports.ShopReply = ShopReply;var updateShopInfo = function updateShopInfo(data, callback) {return post("Shop_authentication/updateShopInfo", data, callback);};
// shop图片删除
exports.updateShopInfo = updateShopInfo;var delimages = function delimages(data, callback) {return post("Shop_authentication/delimages", data, callback);};
// 商家系统消息详情
exports.delimages = delimages;var getShopReplyContent = function getShopReplyContent(data, callback) {return post("shops/getShopReplyContent", data, callback);};
// 页面底部信息1
exports.getShopReplyContent = getShopReplyContent;var getFootInfo = function getFootInfo(data, callback) {return get('foot_Info/index', data, callback);};
// 底部网站信息
exports.getFootInfo = getFootInfo;var getFootConfig = function getFootConfig(data, callback) {return get('Config/index', data, callback);};
// 商家回复评论
exports.getFootConfig = getFootConfig;var setShopReply = function setShopReply(data, callback) {return post("Shop_authentication/setShopReply", data, callback);};
// 小程序码
exports.setShopReply = setShopReply;var getErCode = function getErCode(data, callback) {return post("wechat_mp/getErCode", data, callback);};
// 设置\实名认证
exports.getErCode = getErCode;var getShopAuthentication = function getShopAuthentication(data, callback) {return post("Shop_Authentication/getShopAuthentication", data, callback);};
// 变更手机号
exports.getShopAuthentication = getShopAuthentication;var changemobile = function changemobile(data, callback) {return post("Shop_Authentication/changemobile", data, callback);};
// 用户中心那个new
exports.changemobile = changemobile;var postIsRead = function postIsRead(data, callback) {return post("Shop_authentication/isRead", data, callback);};
// 變更改狀態
exports.postIsRead = postIsRead;var postSetChagesub = function postSetChagesub(data, callback) {return post("Shop_Authentication/setChagesub", data, callback);};exports.postSetChagesub = postSetChagesub;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
//操作成功后，的提示信息
function successToShow() {var msg = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '保存成功';var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
  uni.showToast({
    title: msg,
    icon: 'success',
    duration: 1000 });
...
//加载显示
function loadToShow() {var msg = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '加载中';
  uni.showToast({
    title: msg,
    icon: 'loading' });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.PH = void 0;var PH = {
  ...
  billsReceiveCheck: '/pages/bills/bills_receive_check' };exports.PH = PH;
